console.log(
  (document.getElementById("page-title").innerText = "À procura da felicidade")
);
console.log(
...
console.log(
  (document.getElementById("subtitle").innerText = "The pursuit of Happyness")
);
console.log(
  (document.getElementById("second-paragraph").innerText =
    "The film was released on December 25, 2006 by Columbia Pictures, and received moderately positive reviews, with most critics particularly praising Smith’s performance. The film was nominated for an Oscar and a Golden Globe for Best Actor.")
);
